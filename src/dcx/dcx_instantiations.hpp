...
struct DCXAlgorithm {
    ...
    DCXAlgorithm(PDCXConfig config) : pdcx_config(config) {
...
using DC39_u8_3bit  = DCXAlgorithm<uint8_t, DC39Param, 3>;
using DC39_u8_5bit  = DCXAlgorithm<uint8_t, DC39Param, 5>;
using DC39_u8_8bit  = DCXAlgorithm<uint8_t, DC39Param, 8>;
using DC39_u8       = DCXAlgorithm<uint8_t, DC39Param, 0>;
using DC39_u40      = DCXAlgorithm<dsss::UIntPair<uint8_t>, DC39Param, 0>;
