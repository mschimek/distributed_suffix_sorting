...
std::vector<DC39Algorithm_uint8_5bit_packing::index_t>
DC39Algorithm_uint8_5bit_packing::compute_suffix_array(std::vector<char_t>& local_string,
                                                       kamping::Communicator<>& comm) {
    using DCXParam = dsss::dcx::DC39Param;
    using CharContainer = KPackedInteger<4, char_t, BITS_CHAR, uint64_t>;
